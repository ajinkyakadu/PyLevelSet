...
Level-set algorithm for Inverse Problems using PyTorch
...
* Documentation: [https://ajinkyakadu.github.io/pyLevelSet]
...
- [ ] A conda package
    ...
    - The installation instructions (below) have been updated. Do not
      ...
      some-other-channel`, and your own channel, e.g., `-c ajinkyakadu`.


## Getting Started

It takes a few steps to setup PyLevelSet on your
...
Simply install with:
```
conda install -c cicwi pyLevelSet
```

### Installing from source

To install PyLevelSet, simply clone this GitHub
project. Go to the cloned directory and run PIP installer:
```
git clone https://github.com/ajinkyakadu/pyLevelSet.git
cd pyLevelSet
pip install -e .
```
...
* **Ajinkya Kadu** - *Initial work*

See also the list of [contributors](https://github.com/ajinkyakadu/pyLevelSet/contributors) who participated in this project.
